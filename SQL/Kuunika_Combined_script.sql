...
SELECT 'BHT_EMR' AS 'Program', 'eBRS' AS 'Table', [VARIABLE] AS Element
INTO #Malawi
FROM [BHT_EMR].[dbo].[eBRS]

UNION

SELECT 'BHT_EMR' AS 'Program', 'ANC' AS 'Table', [Variable] AS Element
FROM [BHT_EMR].[dbo].[ANC]

UNION

SELECT 'BHT_EMR' AS 'Program', 'BART' AS 'Table', [VARIABLE] AS Element
FROM [BHT_EMR].[dbo].[BART]

UNION

SELECT 'BHT_EMR' AS 'Program', 'eDRS' AS 'Table', [VARIABLE] AS Element
FROM [BHT_EMR].[dbo].[eDRS]

UNION

SELECT 'BHT_EMR' AS 'Program', 'HTC' AS 'Table', [VARIABLE] AS Element
FROM [BHT_EMR].[dbo].[HTC]

UNION

SELECT 'BHT_EMR' AS 'Program', 'MATERNITY' AS 'Table', [Variable] AS Element
FROM [BHT_EMR].[dbo].[Maternity]

UNION

SELECT 'BHT_EMR' AS 'Program', 'OPD' AS 'Table', [VARIABLE] AS Element
FROM [BHT_EMR].[dbo].[OPD]

UNION

SELECT 'DHA_MIS' AS 'Program', 'DHA' AS 'Table', [concept_name] AS Element
FROM [DHA_MIS].[dbo].[concept]

UNION

SELECT 'HMIS' AS 'Program', 'DHIS' as 'Table', [name] AS Element
FROM [HMIS].[dbo].[DHIS]
WHERE 3 <>''
...
,CASE WHEN LEFT([ELEMENT],3) = 'ANC' THEN 'ANC'
  ...
  WHEN RIGHT([ELEMENT],4) = 'ÀART' THEN 'ART'
...
,CASE WHEN [ELEMENT] LIKE '% HIV %' THEN 'Y'
   ...
   WHEN LEFT([ELEMENT],3) = 'FP ' THEN 'Y' ELSE 'N'
    END AS 'HIV_Flag'
,CASE WHEN [ELEMENT] LIKE '%TOTAL%' OR [ELEMENT] like '%HTC%' OR [ELEMENT] LIKE '%#%' OR [ELEMENT] LIKE '%NUMBER%' OR [ELEMENT] LIKE '%CASES%' OR [ELEMENT] LIKE '%VISITS%' OR [ELEMENT] LIKE '%17%' OR [ELEMENT] LIKE '%PATIENTS%' OR [ELEMENT] LIKE '%DEATHS%' OR [ELEMENT] LIKE '%MONTH%' OR RIGHT([ELEMENT],2) = ' A'  OR RIGHT([ELEMENT],2) = ' B'  OR RIGHT([ELEMENT],2) = ' C'  OR RIGHT([ELEMENT],2) = ' D'  OR RIGHT([ELEMENT],2) = ' E'  OR RIGHT([ELEMENT],2) = ' F'  OR RIGHT([ELEMENT],2) = ' G'  OR RIGHT([ELEMENT],2) = ' H'  OR RIGHT([ELEMENT],2) = ' I'  OR RIGHT([ELEMENT],2) = ' J'  OR RIGHT([ELEMENT],2) = ' K'  OR RIGHT([ELEMENT],2) = ' L'  OR RIGHT([ELEMENT],2) = ' M' THEN 'Y' ELSE 'N'
    END AS 'REPORT_Flag'
--,CASE WHEN LEFT([ELEMENT],2) = 'A ' OR LEFT([ELEMENT],2) = 'B ' OR LEFT([ELEMENT],2) = 'C ' OR LEFT([ELEMENT],2) = 'D ' OR LEFT([ELEMENT],2) = 'E ' OR LEFT([ELEMENT],2) = 'F ' THEN 'Y' ELSE 'N'
--END AS 'REGISTER_Flag'
,CASE WHEN [ELEMENT] LIKE '%TUBERCULOSIS%' OR [ELEMENT] LIKE '%TB%' THEN 'Y' ELSE 'N'
    END AS 'TB_Flag'
,CASE WHEN [ELEMENT] LIKE '% ART' OR [ELEMENT] LIKE 'ART %' OR [ELEMENT] LIKE '% ART %' OR RIGHT([ELEMENT],4) = 'ÀART' THEN 'Y' ELSE 'N'
    END AS 'ART_Flag'
,CASE  WHEN [ELEMENT] LIKE '%MATERN%' OR [ELEMENT] LIKE '%DELIVERY%'  OR [ELEMENT] LIKE '%BIRTH%' OR [ELEMENT] LIKE '%PREGNAN%' OR [ELEMENT] LIKE '%POSTNATAL%' OR LEFT([ELEMENT],4) =  'MAT ' OR [ELEMENT] LIKE '%OBG%' OR [ELEMENT] LIKE '%GYNA%' THEN 'Y' ELSE 'N'
